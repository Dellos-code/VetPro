"""
VetPro - Οθόνη Κτηνιάτρου
Χρησιμοποιεί τις κλάσεις του Class Diagram v1.0
UC1: Προβολή Ιστορικού Ζώου  (HistoryManager, ResultsAnalyzer, DataEnricher)
UC3: Διαχείριση Εμβολιασμών  (VaccineSaver, AllergyChecker, DoseCalculator)
